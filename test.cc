...
int main(int argc, char** argv) {
    ...
    board.createChessPiece(White, King, 2,1);
    board.createChessPiece(Black, Rook, 3,1);
    std::cout << "INITAL BOARD: \n";
    std::cout << board.displayBoard().str();
    std::cout <<  board.movePiece(2,1,1,2)<< std::endl;
    std::cout << board.displayBoard().str();
...
//     std::cout << "INITAL BOARD: \n";
//     std::cout << board.displayBoard().str();
//     // std::cout << board.isPieceUnderThreat(3,2) << std::endl;
